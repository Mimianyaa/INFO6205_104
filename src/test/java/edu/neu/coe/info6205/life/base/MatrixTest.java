...
public class MatrixTest {
    ...
    public void testToString() {
        Matrix target = new Matrix(10, 5);

        target.addCell(new Point(1, 0));
        target.addCell(new Point(2, 0));
        target.addCell(new Point(3, 0));
        target.addCell(new Point(4, 0));
        target.addCell(new Point(3, 1));
        target.addCell(new Point(4, 1));
        String render = target.render();
